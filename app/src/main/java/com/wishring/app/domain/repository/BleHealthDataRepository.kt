...
/**
 * Repository interface for BLE health data operations
 * Manages health monitoring, user profiles, and device settings
 */
interface BleHealthDataRepository {
 ...
 */
// UserProfile은 domain.model.UserProfile.kt에서 import됩니다

/**
 * Gender enum
 */
// Gender는 domain.model.UserProfile.kt에서 import됩니다

/**
 * Activity level enum
 */
// ActivityLevel은 필요시 domain.model에서 정의할 수 있습니다

/**
 * Heart rate data class
 */
// HeartRateData는 domain.model.HealthData.kt에서 import됩니다

/**
 * Blood pressure data class
 */
// BloodPressureData는 domain.model.HealthData.kt에서 import됩니다

/**
 * Sleep data class
 */
// SleepData는 domain.model.HealthData.kt에서 import됩니다

/**
 * Step data class
 */
// StepData는 domain.model.HealthData.kt에서 import됩니다

/**
 * Temperature data class
 */
// TemperatureData는 domain.model.HealthData.kt에서 import됩니다

/**
 * Temperature type enum
 */
// TemperatureType은 필요시 domain.model에서 정의할 수 있습니다

/**
 * ECG data class
 */
// EcgData는 domain.model.HealthData.kt에서 정의되어야 합니다

/**
 * Blood oxygen data class
 */
// BloodOxygenData는 domain.model.HealthData.kt에서 정의되어야 합니다

/**
 * Data quality enum
 */
// DataQuality는 domain.model.HealthData.kt에서 import됩니다
